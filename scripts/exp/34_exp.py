...
@hydra.main(config_path="../../config/exp", config_name="34_exp")
def main(cfg):
    ...
    # Annealed cyclic SVGD 
    alpha = alpha_cyclic(cfg.params.num_iterations, C=8, p=2, device=device)
    ...
    #Save the dictionary 
    save_dict_as_compressed_npz(f"{cfg.paths.out_path}34_results_svgd.npz", results_svgd)
